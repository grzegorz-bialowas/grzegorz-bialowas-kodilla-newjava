...
public class ForumTestSuite {
    ...
    public void testAddPost() {
        ...
        //When
        forumUser.addPost("John Smith", "Hello everyone, this is my first contribution here!");
        //Then
    ...
    public void testGetPost() {
        ...
        //When
        ForumPost newPost = forumUser.getPost(0);
        //Then
        Assert.assertEquals(thePost, newPost);
    }
    @Test
    public void testGetComment() {
        ...
        //When
        ForumComment newComment = forumUser.getComment(0);
        //Then
        Assert.assertEquals(forumComment, newComment);
    }
    @Test
